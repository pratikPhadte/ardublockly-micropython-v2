...
/** @return {!string} Generated Micropython code from the Blockly workspace. */
Ardublockly.generateMicropython = function () {
    return Blockly.Micropython.workspaceToCode(Ardublockly.workspace);
};
