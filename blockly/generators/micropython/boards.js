...
goog.provide('Blockly.Micropython.Boards');

goog.require('Blockly.Micropython');
goog.require('Blockly.Arduino.Boards.profiles.uno');
 ...
 *     digital IO pins.
 */
Blockly.Micropython.Boards.generateDigitalIo = function(pinStart, pinEnd) {
  var digitalIo = [];
 ...
 *     analogue IO pins.
 */
Blockly.Micropython.Boards.generateAnalogIo = function(pinStart, pinEnd) {
  var analogIo = [];
  for (var i = pinStart; i < (pinEnd + 1); i++) {
 ...
 */
Blockly.Micropython.Boards.duplicateBoardProfile =
...
Blockly.Micropython.Boards.profiles = new Object();
...
//  analogPins: Blockly.Micropython.Boards.generateAnalogIo(0, 5),
//  digitalPins: Blockly.Micropython.Boards.generateDigitalIo(0, 13).concat(
//                   Blockly.Micropython.Boards.generateAnalogIo(0, 5)),
...
//Blockly.Micropython.Boards.profiles.nano_328 = {
//  name: 'Arduino Nano 328',
//  description: 'Arduino Nano with ATmega328 board',
//  compilerFlag: 'arduino:avr:nano:cpu=atmega328',
//  analogPins: Blockly.Micropython.Boards.generateAnalogIo(0, 7),
//  digitalPins: Blockly.Micropython.Boards.generateDigitalIo(0, 13).concat(
//                   Blockly.Micropython.Boards.generateAnalogIo(0, 7)),
...
//};
//Blockly.Micropython.Boards.profiles.nano_168 =
//    Blockly.Micropython.Boards.duplicateBoardProfile(
//        Blockly.Micropython.Boards.profiles.nano_328,
//        'Arduino Nano 168',
...
//Blockly.Micropython.Boards.profiles.duemilanove_168p = {
...
//  interrupt: Blockly.Arduino.Boards.profiles.uno.interrupt
//};
//Blockly.Micropython.Boards.profiles.duemilanove_328p =
//    Blockly.Micropython.Boards.duplicateBoardProfile(
//        Blockly.Micropython.Boards.profiles.duemilanove_168p,
...
//Blockly.Micropython.Boards.profiles.mega = {
//  name: 'Arduino Mega',
//  description: 'Arduino Mega-compatible board',
//  compilerFlag: 'arduino:avr:mega',
//  analogPins: Blockly.Micropython.Boards.generateAnalogIo(0, 15),
//  //TODO: Check if the Mega can use analogue pins as digital, it would be
//  //      logical but it is not clear on the arduino.cc website
//  digitalPins: Blockly.Micropython.Boards.generateDigitalIo(0, 53),
//  pwmPins: Blockly.Micropython.Boards.generateDigitalIo(2, 13).concat(
//               Blockly.Micropython.Boards.generateDigitalIo(44, 46)),
...
//Blockly.Micropython.Boards.profiles.leonardo = {
//  name: 'Arduino Leonardo',
//  description: 'Arduino Leonardo-compatible board',
//  compilerFlag: 'arduino:avr:leonardo',
//  analogPins: Blockly.Micropython.Boards.generateAnalogIo(0, 5).concat(
//                  [['A6', '4'], ['A7', '6'], ['A8', '8'], ['A9', '9'],
//                   ['A10', '10'], ['A11', '12']]),
//  digitalPins: Blockly.Micropython.Boards.generateDigitalIo(0, 13).concat(
//                   Blockly.Micropython.Boards.generateAnalogIo(0, 5)),
...
//Blockly.Micropython.Boards.profiles.yun =
//    Blockly.Micropython.Boards.duplicateBoardProfile(
//        Blockly.Micropython.Boards.profiles.leonardo,
//        'Arduino Yun',
...
//Blockly.Micropython.Boards.profiles.atmel_atmega328p_xplained_mini = {
...
//};
//Blockly.Micropython.Boards.profiles.atmel_atmega328pb_xplained_mini =
//    Blockly.Micropython.Boards.duplicateBoardProfile(
//        Blockly.Micropython.Boards.profiles.atmel_atmega328p_xplained_mini,
...
//Blockly.Micropython.Boards.profiles.atmel_atmega168pb_xplained_mini =
//    Blockly.Micropython.Boards.duplicateBoardProfile(
//        Blockly.Micropython.Boards.profiles.atmel_atmega328p_xplained_mini,
...
//Blockly.Micropython.Boards.profiles.esp8266_huzzah = {
...
Blockly.Micropython.Boards.profiles.esp8266_wemos_d1 = {
  name: 'Wemos D1',
...
Blockly.Micropython.Boards.selected = Blockly.Micropython.Boards.profiles.esp8266_wemos_d1;
 ...
 */
Blockly.Micropython.Boards.changeBoard = function(workspace, newBoard) {
  if (Blockly.Micropython.Boards.profiles[newBoard] === undefined) {
    console.log('Tried to set non-existing board: ' + newBoard);
    return;
  }
  Blockly.Micropython.Boards.selected = Blockly.Micropython.Boards.profiles[newBoard];
 ...
 */
Blockly.Micropython.Boards.refreshBlockFieldDropdown =
    function(block, fieldName, boardKey) {
  var field = block.getField(fieldName);
  var fieldValue = field.getValue();
  var dataArray = Blockly.Micropython.Boards.selected[boardKey];
