...
goog.provide('Blockly.Micropython.spi');
...
// */
//Blockly.Micropython['spi_setup'] = function (block) {
...
//    Blockly.Micropython.addInclude('spi', '#include <SPI.h>');
//    Blockly.Micropython.addSetup('spi_order',
//        spiId + '.setBitOrder(' + spiShift + ');', true);
//    Blockly.Micropython.addSetup('spi_mode',
//        spiId + '.setDataMode(' + spiMode + ');', true);
//    Blockly.Micropython.addSetup('spi_div',
//        spiId + '.setClockDivider(' + spiClockDivide + ');', true);
//    Blockly.Micropython.addSetup('spi_begin',
//        spiId + '.begin();', true);
...
// * @return {string} Completed code.
// */
//Blockly.Micropython['spi_transfer'] = function (block) {
//    var spiId = block.getFieldValue('SPI_ID');
//    var spiSs = block.getFieldValue('SPI_SS');
//    var spiData = Blockly.Micropython.valueToCode(
//        block, 'SPI_DATA', Blockly.Micropython.ORDER_ATOMIC) || '0';

//    Blockly.Micropython.addInclude('spi', '#include <SPI.h>');
//    Blockly.Micropython.addSetup('spi_begin', spiId + '.begin();', false);

//    // Reserve SPI pins MOSI, MISO, and SCK
//    var spiPins = Blockly.Micropython.Boards.selected.spiPins[spiId];
//    for (var i = 0; i < spiPins.length; i++) {
//        Blockly.Micropython.reservePin(block, spiPins[i][1],
//            Blockly.Micropython.PinTypes.SPI, 'SPI ' + spiPins[i][0]);
//    }

//    // Configure the Slave Select as a normal output if a pin is used
//    if (spiSs !== 'none') {
//        Blockly.Micropython.reservePin(
//            block, spiSs, Blockly.Micropython.PinTypes.OUTPUT, 'SPI Slave pin');
//        var setupCode = 'pinMode(' + spiSs + ', OUTPUT);';
//        Blockly.Micropython.addSetup('io_' + spiSs, setupCode, false);
...
// * @return {string} Completed code.
// */
//Blockly.Micropython['spi_transfer_return'] = function (block) {
//    var spiId = block.getFieldValue('SPI_ID');
//    var spiSs = block.getFieldValue('SPI_SS');
//    var spiData = Blockly.Micropython.valueToCode(
//        block, 'SPI_DATA', Blockly.Micropython.ORDER_ATOMIC) || '0';
//    // The spi_transfer block invoked to generate all setup stuff, code discarded
//    var spiTransferOnlyCode = Blockly.Micropython['spi_transfer'](block);
//    if (spiSs === 'none') {
//        var code = spiId + '.transfer(' + spiData + ')';
//    } else {
//        var func = [
//            'int ' + Blockly.Micropython.DEF_FUNC_NAME + '() {',
//            '  int spiReturn = 0;',
...
//            '  return spiReturn;',
//            '}'];
//        var functionName = Blockly.Micropython.addFunction(
